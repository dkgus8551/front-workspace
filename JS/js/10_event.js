...
window.onload=function(){
    document.querySelector("#btn2").onclick = test1; // 바인딩 시 () 안 붙임
    ...
    document.querySelector("#btn3").addEventListener("click", function(){
        console.log("22222222222222 btn3 clicked!");
    });

    /*
        Event 객체
         - 발생한 이벤트 관련 모든 정보를 가지고 있는 객체
         - 이벤트가 발생한 요소, 발생한 이벤트의 유형, html 내부의 위치 정보 등
   ...
   document.querySelector("form").onsubmit=function(e){
    /*
        사용자가 입력한 값이 유효한 값인지 유효성 검사를 진행하기 위해 작성함
    */
   console.log(e);
   // 1. 아이디 검사
